...
public class Camera2VideoFragment extends Fragment implements View.OnClickListener {
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        mMediaRecorder.setOutputFile(new File(Environment.getExternalStorageDirectory(), "VID" + System.currentTimeMillis() + ".mp4").getAbsolutePath());
    ...
    private File getVideoFile(Context context) {
        File file = new File(Environment.getExternalStorageDirectory(), "VID" + System.currentTimeMillis() + ".mp4");
        return file;
    }
